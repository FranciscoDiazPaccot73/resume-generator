...
const template2 = (doc, info, options) => {
  ...
  doc.setFont("default", 'normal');
  doc.setFontSize(10);
  let perfilText = 'Abogada joven e innovadora dedidaca con pasion al ejercicio de la profesion. Fuerte, decidida y con gran capacidad de actuar bajo presion. Responsable.'
